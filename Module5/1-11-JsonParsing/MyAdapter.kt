...
class MyAdapter(var context:Context,var list:MutableList<Model>) :BaseAdapter()
{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View
    {
        ...
        Picasso.get().load(list.get(position).cricketer_photo).placeholder(R.mipmap.ic_launcher).into(img1)
        txt1.setText(list.get(position).cricketer_name)
        txt2.setText(list.get(position).cricketer_hscore)
        return view
    }
